...
##window.wm_iconbitmap("ridiculous.ico")
...
btn_logclr = tkinter.Button(window, text="Clear Log", command=lambda:text_servermsg.delete('1.0', END), width=15)
#Place widgits
